package com.dr.code.diff.common.aop;


import com.dr.code.diff.common.annotation.IdempotentCheck;
import javassist.*;
...
//    private IUcsCache ucsCache;
    ...
    @Pointcut("@annotation(com.dr.code.diff.common.annotation.IdempotentCheck)")
